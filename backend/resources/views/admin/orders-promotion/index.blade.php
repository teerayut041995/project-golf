                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                          ...
                          <table id="load-datatable" class="table table-bordered table-striped">
                            ...
                            <tr>
                              <th>ชื่อโปรโมชัน</th>
                              <th style="width: 15%;">สมาชิกที่ซื้อโปรโมชัน</th>
                              <th>ราคา</th>
                              <th style="width: 15%;">ระยะเวลาโปรโมชัน</th>
                            ...
                            <tr>
                              <td>{{$order->promotion->pro_name}}</td>
                              <td>
                              ...
                              if ($now < $order->start_date) {
                                ...
                                <span class="pull-center-container">
                                  <small class="label pull-center bg-green">ยังไม่เริ่มโปรโมชัน</small>
                                </span>
                                <?php
                              } else if ($now > $order->end_date) {
                                ?>
                                <span class="pull-center-container">
                                  <small class="label pull-center bg-red">หมดโปรโมชันแล้ว</small>
                                </span>
                                <?php
                              } else {
                                ...
                                ?>
                                <span class="pull-center-container">
                                  <small class="label pull-center bg-blue">อยู่ในช่วงโปรโมชั่น</small>
                                </span>
                                <?php
                                }
                              }    
                              ...
                              <td>
                                  <a href="{{url('/admin/orders/promotions' , $order->id)}}" class="btn btn-info btn-xs btn-block">ตรวจสอบข้อมูล</a>
