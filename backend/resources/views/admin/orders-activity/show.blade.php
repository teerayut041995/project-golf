...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('/admin/orders/promotions')}}">รายการสั่งซื้อกิจกรรม</a></li>
        <li class="active">{{$order->activity->act_name}}</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="row">
                ...
                <div class="col-md-9">{{$order->activity->pro_name}}</div>
              </div>
              <p></p>
              <div class="row">
              ...
              <div class="box-body">
                @if($order->bank_id != '')
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <img src="{{url('images/activity-payment', $order->payment_image)}}" style="width: 100%;">
                    </div>
                  </div>
                  <form method="POST" action="{{url('/admin/orders/activities' , $order->id)}}">
                      @csrf
                      @method('PATCH')
